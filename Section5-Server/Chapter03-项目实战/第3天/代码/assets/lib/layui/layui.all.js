...
!(function (e) {
    ...
    var t = document,
        ...
        r = (function () {
            var e = t.currentScript
                ...
                : (function () {
                      for (
                          var e, o = t.scripts, n = o.length - 1, r = n;
                          r > 0;
                          r--
                      )
    ...
    (n.prototype.cache = o),
                ...
                'function' != typeof n
                    ...
                    : ((function p() {
                          return ++y > (1e3 * o.timeout) / 100
                              ...
                              : void (1989 ===
                                parseInt(
                                    a.getStyle(t.getElementById(c), 'width')
                                )
                                    ? (function () {
                                          n();
                                      })()
        ...
        (n.prototype.factory = function (e) {
            if (layui[e])
                return 'function' == typeof o.callback[e]
                    ? o.callback[e]
                    : null;
        }),
                    ...
                    (o.rel = 'stylesheet'),
                        ...
                        'function' == typeof a &&
                            !(function c() {
                                return ++d > 80
                                    ? window.console &&
                                          console.error('laydate.css: Invalid')
                                    : void (1989 ===
                                      parseInt(
                                          t.getStyle(
                ...
                var t = 0,
                    n =
                        'object' == typeof e
                            ? [e]
                            : ((this.selector = e),
                              document.querySelectorAll(e || null));
                t < n.length;
                t++
            )
                this.push(n[t]);
    ...
    (C.prototype = []),
        ...
        (C.prototype.find = function (e) {
            ...
            return (
                this.each(function (r, o) {
                    for (
                        var s = i ? [e] : o.querySelectorAll(e || null);
                        n < s.length;
                        n++
                    )
                        a.push(s[n]);
        ...
        (T.prototype.init = function () {
            ...
            (t.elem = w(t.elem)),
                ...
                t.elem[0] &&
                    ...
                    e.isInput(t.elem[0]) ||
                        ('focus' === t.trigger && (t.trigger = 'click')),
                    t.elem.attr('lay-key') ||
                        (t.elem.attr('lay-key', e.index),
                    ...
                    t.value &&
                        t.isInitValue &&
                        (t.value.constructor === Date
                            ? e.setValue(e.parse(0, e.systemDate(t.value)))
                            : e.setValue(t.value)));
        }),
        (T.prototype.render = function () {
            ...
            e.remove(T.thisElemDate),
                a
                    ? t.elem.append(i)
                    : (document.body.appendChild(i), e.position()),
        ...
        (T.prototype.position = function () {
            ...
            d + i + l > s('width') && (d = s('width') - i - l),
                c + r + l > s() &&
                    ((c = a.top > r ? a.top - r : s() - r), (c -= 2 * l)),
                t.position && (e.elem.style.position = t.position),
                (e.elem.style.left =
                    d + ('fixed' === t.position ? 0 : o(1)) + 'px'),
                (e.elem.style.top =
                    c + ('fixed' === t.position ? 0 : o()) + 'px');
        }),
        ...
        (T.prototype.checkDate = function (e) {
                        ...
                        w.each(i.format, function (s, l) {
                            ...
                            t[s].length < l.length && (a = !0),
                                /yyyy|y/.test(l)
                                    ...
                                    ? (c < 1 && ((c = 0), (a = !0)),
                                      (e.hours = c),
                                      r.range && (i[o[n]].hours = c))
                                    : /mm|m/.test(l)
                                    ? (c < 1 && ((c = 0), (a = !0)),
                                      (e.minutes = c),
                                      r.range && (i[o[n]].minutes = c))
                                    : /ss|s/.test(l) &&
                                      (c < 1 && ((c = 0), (a = !0)),
                                      (e.seconds = c),
            ...
            return 'limit' === e
                ...
                : ((l = l || r.value),
                  ...
                  i.startState &&
                      !i.endState &&
                      (delete i.startState, (i.endState = !0)),
                  'string' == typeof l && l
                      ? i.EXP_IF.test(l)
                          ? r.range
                              ? ((l = l.split(' ' + r.range + ' ')),
                  ...
                  a &&
                      l &&
                      i.setValue(
                          r.range ? (i.endDate ? i.parse() : '') : i.parse()
                      ),
                  e && e(),
                  i);
        }),
        ...
        (T.prototype.calendar = function (e) {
                    ...
                    (n = w(n)),
                        ...
                        e < t
                            ? ((c = a - t + e),
                              ...
                              (d = r.getAsYM(l.year, l.month, 'sub')))
                            : e >= t && e < i + t
                            ? ((c = e - t),
                              s.range || (c + 1 === l.date && n.addClass(o)))
                            : ((c = e - i - t),
                ...
                'cn' === s.lang
                    ? (w(f[0])
                      ...
                      w(f[1])
                          .attr('lay-type', 'month')
                          .html(l.month + 1 + '月'))
                    : (w(f[0]).attr('lay-type', 'month').html(m.month[l.month]),
            ...
            return (
                s.range ||
                    r.limit(w(r.footer).find(g), null, 0, [
                        'hours',
                        'minutes',
                        'seconds',
                    ]),
            ...
            if ((T[0] < 1 && (T[0] = 1), 'year' === e)) {
                ...
                w.each(new Array(12), function (e) {
                    ...
                    e + 1 == T[1] && w(i).addClass(o),
                        ...
                        d.appendChild(i),
                        T[0] < n.firstDate.year
                            ? (s.date = a.min.date)
                            : T[0] >= n.firstDate.year && (s.date = a.max.date),
                        n.limit(w(i), s, t);
                }),
                    w(u[f ? 0 : 1])
                        .attr('lay-ym', T[0] + '-' + T[1])
                ...
                var E = function () {
                    w(d)
                        ...
                        a.range ||
                            n.limit(w(n.footer).find(g), n[x], 0, [
                                'hours',
                                'minutes',
                                'seconds',
                            ]);
                ...
                a.range
                    ? n[x] || (n[x] = { hours: 0, minutes: 0, seconds: 0 })
                    : (n[x] = i),
            ...
            var n = this,
                ...
                i =
                    ...
                    (e
                        ...
                        : a.range
                        ? w.extend({}, n.startDate, n.startTime)
                        : a.dateTime),
                r = n.format.concat();
            return (
                w.each(r, function (e, t) {
                    /yyyy|y/.test(t)
                        ...
                        : /ss|s/.test(t) &&
                          (r[e] = w.digit(i.seconds, t.length));
                }),
                a.range && !e
                    ? r.join('') + ' ' + a.range + ' ' + n.parse(1)
                    : r.join('')
            );
        }),
        ...
        (T.prototype.stampRange = function () {
            var e,
                ...
                i = w(n.elem).find('td');
            if (
                (a.range && !n.endDate && w(n.footer).find(g).addClass(s),
                n.endDate)
            )
                return (
                    (e = n
                    ...
                    e && w.extend(a, r),
                        n.range &&
                            (t.startDate
                                ...
                                : (t.startDate = w.extend({}, r, t.startTime)),
                            (t.startYMD = r));
                };
            if (
                ((r = {
                ...
                if (n.range) {
                    if (
                        ...
                        if (
                            ...
                            t.endDate
                                ...
                                : (t.endDate = w.extend({}, r, t.endTime)),
                            t.newDate(r).getTime() <
                    ...
                    w(t.footer)
                        .find(g)
                        [t.endDate ? 'removeClass' : 'addClass'](s);
                } else
                    'static' === n.position
                ...
                s = function (s) {
                    ...
                    return (
                        ...
                        (d || c) &&
                            ...
                            t.setBtnStatus(),
                            n.range ||
                                t.limit(w(t.footer).find(g), { year: o[0] })),
                        d || c
                    );
                };
            return {
            ...
            e.elemColorBox.on('click', function () {
                ...
                o.elem[0] &&
                    ...
                    B.on('resize', function () {
                        return (
                            !(!e.elemPicker || !i(c)[0]) && void e.position()
                        );
                    }),
    ...
    (x.prototype.config = {
        ...
        (x.prototype.render = function () {
            ...
            l[0] &&
                ...
                (e.layData = i.find('.' + y)),
                (e.layBtn = i.find('.' + f + ' .layui-btn')),
                e.layBox.css({ width: n.width, height: n.height }),
                e.layData.css({
                    height: (function () {
                        return (
                            n.height -
    ...
    var t = layui.$,
        ...
        s = function (e) {
            ...
            return (
                t ||
                    o.error(
                        'The ID option was not found in the table instance'
                    ),
                t || null
            );
        },
    ...
    (j.prototype.config = {
        ...
        (j.prototype.render = function () {
            ...
            var l = a.elem,
                n = l.next('.' + v),
                o = (e.elem = t(
                    i(H).render({ VIEW_CLASS: v, data: a, index: e.index })
                ));
            if (
                ((a.index = e.index),
                (e.key = a.id || a.index),
                ...
                i.layBody
                    .on('mouseenter', 'tr', function () {
                        var e = t(this),
                            a = e.index();
                        e.data('off') ||
                            i.layBody.find('tr:eq(' + a + ')').addClass(_);
                    })
                    .on('mouseleave', 'tr', function () {
                        var e = t(this),
                            a = e.index();
                        e.data('off') ||
                            i.layBody.find('tr:eq(' + a + ')').removeClass(_);
                    })
...
layui.define('jquery', function (e) {
    ...
    (v.prototype.config = {
        ...
        (v.prototype.render = function () {
            ...
            n +=
                '</ul>' +
                (i.text ? '<span class="layui-inline">' + i.value + '星' : '') +
                '</span>';
            var c = i.elem,
                f = c.next('.' + t);
            f[0] && f.remove(),
                ...
                v.on('click', function (e) {
                    ...
                    v.on('mousemove', function (e) {
                        if (
                            ...
                            c <= n / 2 &&
                                v.children('i').addClass(u).removeClass(s);
                        }
                    }),
                ...
                c = {
                    ...
                    help: function () {
                        i.open({
                            ...
                            content: [
                                'http://www.layui.com/about/layedit/help.html',
                                'no',
                            ],
                        });
                    },
            ...
            (e = e || {}),
                ...
                layui.each(t.reverse(), function (t, i) {
                    ...
                    c.addClass('layui-box layui-code-view'),
                        (c.attr('lay-skin') || e.skin) &&
                            c.addClass(
                                'layui-code-' + (c.attr('lay-skin') || e.skin)
                            ),
                        ((d.find('li').length / 100) | 0) > 0 &&
                            d.css(
                                'margin-left',
                                ((d.find('li').length / 100) | 0) + 'px'
                            ),
                        (c.attr('lay-height') || e.height) &&
                            d.css(
                                'max-height',
                                c.attr('lay-height') || e.height
                            );
